            ...
            <div class="col-12 col-sm-10 mx-auto">
                ...
                <form id="form_user_profile" action="{{ route('user.profile.update', ['user'=>$user]) }}" method="POST" class="bg-white rounded shadow p-3" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <button type="button" id="btn_update_user" class="btn btn-success shadow">Guardar <i class="far fa-save"></i></button>
                    </div>
                    @csrf
                    @method("PUT")
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-5 col-md-5 mx-auto">
                            ...
                            <div class="form-group">
                                <div class="col-10 custom-input-file">
                                    <input type="file" name="profile_photo" accept=".png, .jpg, .jpeg" id="input_file_user_profile_image" class="input-file">
                                    Elegir...
                                </div>
                            </div>
                        </div>
